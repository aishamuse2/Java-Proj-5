...
//    public static int getMissingNo(int nums[], int maxNum)
//    {
...
//        return 0;
//    }
//    public static int missingNumber1(int[] nums, int maxNum) {
//        Arrays.sort(nums);
//
//        for (int i = 1; i < maxNum; i += 1) {
//            if (i != nums[i - 1]) {
...
//        System.out.println(getMissingNo(nums, maxNum));
//        System.out.println(missingNumber1(nums, maxNum));
